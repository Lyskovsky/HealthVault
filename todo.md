...
- **Давление**: 📉 Стабилизировать **< 125/80**. Мерять **и утром и вечером** (паттерн non-dipper — давление не снижается ночью — независимый предиктор инфаркта, виден только по вечернему замеру).
- **Инсулинорезистентность**: Снижение висцерального жира улучшит чувствительность к инсулину.

### 🧪 Анализы крови раз в квартал
> Следующий чек-ап: ~начало апреля 2026 (почти квартал с 6 января)

**Обязательно каждый квартал:**
- Липидограмма расширенная: Общий, LDL, HDL, Триглицериды + **ApoB** (точнее LDL как маркер кардиориска)
- **Глюкоза натощак + Инсулин натощак** → вычислить HOMA-IR (индекс инсулинорезистентности)
- **HbA1c** (гликированный гемоглобин — средний сахар за 3 месяца)
- **hs-CRP** (высокочувствительный С-реактивный белок — маркер системного воспаления)
- Тестостерон общий + **ГСПГ** (→ вычислить свободный тестостерон)
- Витамин D (25-OH)
- **Ферритин** (энергия, восстановление мышц)
- ОАК (общий анализ крови — эритроциты, лейкоциты, тромбоциты)
- АЛТ/АСТ (печень — важно при приёме добавок)

**Один раз (или раз в год):**
- **Lp(a)** — генетический маркер кардиориска, почти не меняется, но важно знать значение
- **Гомоцистеин** — кардиориск, коррелирует с B12/фолатом
- **B12** (особенно если редко ешь мясо)
- **ТТГ** (щитовидная железа)
- **Омега-3 индекс** (раз в полгода при приёме добавки)

### 🎁 Устройства (Wishlist)
- [ ] **Fenix 8** — день рождения 15 мая 2026. Даст: датчик температуры кожи, точнее HRV, лучше SpO2, новый дизайн. Fenix 8 Solar vs Fenix 8 AMOLED — смотреть по батарее.

### 📊 Новые Потоки Данных (к внедрению)
- [ ] **CGM (непрерывный мониторинг глюкозы)**: купить Abbott FreeStyle Libre 3, носить 2 недели, подключить данные к HealthVault. Показывает как конкретные продукты влияют на твой сахар — ключ к пониманию инсулинорезистентности.
- [ ] **Динамометр**: купить кистевой динамометр (~2000-3000 руб). Мерять раз в 2 недели, 3 сжатия каждой рукой. Добавить в бот как замер тела. Сила хвата — #1 предиктор долголетия по UK Biobank (502k человек).
- [ ] **DEXA-скан**: найти клинику в Москве, делать раз в квартал (~3000-7000 руб). Золотой стандарт состава тела — точнее Zepp, даёт висцеральный жир отдельно и плотность костей.
